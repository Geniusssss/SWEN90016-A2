            ...
            <div v-loading="loading">
                <div class="row">
                    ...
                    <el-upload :disabled="optionValue == ''" action="" :show-file-list="false" :on-change="handleUpload"
                        :auto-upload="false">
                        <el-button type="primary" @click="selectWarning" :disabled="!user.ddeAccess.create">Upload<i
                    ...
                    <el-card class="box-card">
                        <div slot="header" class="card-header">
                            ...
                            <el-button style="margin-left: 55%; width: 100px;" type="primary" plain size="small"
                                :disabled="!user.ddeAccess.download" @click="downloadFile(item)"><i
                                    class="el-icon-download el-icon--left"></i>Download
                            </el-button>
                            <el-popconfirm placement="top" title="Are you sure to delete?" confirm-button-type="text"
                                ...
                                <el-button slot="reference" style="width: 100px;" type="danger" plain size="small"
                                    :disabled="!user.ddeAccess.delete"><i
                                        class="el-icon-delete el-icon--left"></i>Delete
                                </el-button>
                            </el-popconfirm>
                        </div>
                        <div v-if="item.fileType == 'Sentence' || item.fileType == 'Symbol'"
                        ...
                        <div v-if="item.fileType == 'Image'">
                            <el-card class="card-image">
                                ...
                                <img :src="item.fileCode" class="image" oncontextmenu="return false"
                                    ondragstart="return false">
                            </el-card>
                        </div>
                        <div v-if="item.fileType == 'Song'">
                            <div class="music-title">{{item.fileName}}</div>
                            <audio controls controlsList="nodownload" class="audio" oncontextmenu="return false">
